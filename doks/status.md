...
gemeinsame Präsentationsmodell. UX-02 rendert daraus im Windows-Client nun den
vollständigen serverdefinierten Kanalbaum und alle sichtbaren Teilnehmer
einschließlich getrennter Presence-, Audio- und Sprechzustände, öffentlicher
Rollen sowie lokaler Lautstärke-, Mute- und Blockregeln. Lade-, Leer-, Trenn-,
Stale- und Unauthorized-Zustände sind explizit und ein Rechteverlust löscht
veraltete Directory-Daten.
...
- [UX-02: Kanal- und Teilnehmeransicht](archive/ux-02-channel-and-participant-view-2026-07-28.md)
...
| Präsentation | Plattformneutrale Zustände, Befehle und Validierung; deterministischer Kanalbaum, abgeleitete Teilnehmermengen, Directory-Phasen sowie scopeübergreifende Presence-, Audio- und Sprechzustände getestet |
| Windows-App | Getrennte Haupt-, Einstellungs- und Diagnosefenster; Anmeldung, Directory-/Presence-Polling, vollständiger Kanalbaum, alle sichtbaren Teilnehmer, lokale Teilnehmerregeln, Verbindung und PTT in WinUI 3 verdrahtet |
...
Barrierefreiheit und Bedienbarkeit sind noch nicht vollständig mit realen
Benutzerabläufen und verschiedenen Eingabegeräten abgenommen. Die
selbstenthaltene Windows-App-SDK-Laufzeit meldet dynamische
Teilnehmersteuerelemente im Raw-UIA-Baum als `Custom`; Namen, Tooltips und
Automation-IDs sind gesetzt, die reale Screenreader-Matrix bleibt ein
QA-01-Gate. Datenschutz-, Abhängigkeits- und Bedrohungsmodell, signiertes MSIX,
versionierte Linux-Container sowie Betriebs-, Konfigurations-, Account-,
Moderations-, Diagnose- und Integrationsdokumentation sind nicht abgeschlossen.
...
Nicht mit Abschnitt 10.3 beginnen. Als nächstes KDE-01 des
[aktuellen Umsetzungsplans](implementation-plan.md) umsetzen: die gemeinsame
Präsentations- und Client-Core-Grenze in eine vollständige Qt-6-/KDE-Schale
überführen. Zuerst sind der Linux-HTTP-Adapter und die Hauptansicht mit
demselben Kanal-, Teilnehmer-, Verbindungs- und PTT-Modell wie unter Windows
anzubinden; danach folgen die eigenständigen Einstellungs-, Diagnose- und
Verwaltungsfenster.
...
- Kanalbaum und Teilnehmerzustände funktionieren mit zwei realen
  Windows-Clients Ende-zu-Ende (Windows-Anteil mit UX-02 erfüllt);
